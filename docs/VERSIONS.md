...
|----------|-----------|--------|
| **V0.0.1** | โค้ดพอร์ทัล + UI + 7 โมดูล + auth/R2 ในโค้ด | tagged `v0.0.1` / `release/0.0.1` |
...
- เงินครัวเรือนร่วม / โหมดพ่อแม่–ลูก (นอก family MVP ปัจจุบัน)

หลัง V0.1.0: ดูแผนคลื่นที่ [ROADMAP.md](./ROADMAP.md) — โมดูลครอบครัว (`/family`) **shipped เป็น MVP แยกสมุด** (แชท/โลเคชัน/ซื้อของ/งานบ้าน) ไม่บล็อก tag `v1.0.0` ของสมุดคนเดียว และยังไม่แชร์ ledger ส่วนตัว
