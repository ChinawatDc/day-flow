...
หลัง V0.1.0 (ยังไม่เปิดงาน): ดูแผนคลื่น V0.1.x → V1.0.0 ที่ [ROADMAP.md](./ROADMAP.md) — V0.1.x แพตช์ของจริง, V0.2 สมุดใบเดียว (UX ทั้งระบบ + ตัวพิมพ์น่ารัก), V0.3 ค้นหา+แก้+งบเดือน, ไม่ทำ LINE/AI/ครอบครัวก่อน tag `v1.0.0`
