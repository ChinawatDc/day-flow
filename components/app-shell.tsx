  ...
  return (
    <div className="df-canvas min-h-dvh md:grid md:grid-cols-[15.5rem_minmax(0,1fr)]">
      ...
      <div className="flex min-h-dvh flex-col pb-8 md:pb-0">
        <header className="sticky top-0 z-30 border-b border-[var(--stroke)] bg-[color-mix(in_oklch,var(--canvas)_82%,transparent)] px-4 py-4 backdrop-blur-[var(--blur-nav)] md:static md:border-0 md:bg-transparent md:px-8 md:pt-8 md:pb-4 md:backdrop-blur-none">
