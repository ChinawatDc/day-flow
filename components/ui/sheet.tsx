  ...
  return (
    <DialogPrimitive.Portal>
      ...
      <DialogPrimitive.Content
        className={cn(
          "fixed z-50 bg-[var(--elevated)] p-5 shadow-[var(--shadow-lg)] outline-none backdrop-blur-[var(--blur-sheet)]",
          side === "bottom" &&
            "inset-x-0 bottom-0 rounded-t-[var(--radius-xl)] border-t border-[var(--stroke)]",
          side === "left" && "inset-y-0 left-0 w-72 border-r border-[var(--stroke)]",
          className,
        )}
        {...props}
      >
